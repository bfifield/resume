...
\href{https://www.princeton.edu}{{\bf Princeton University}}, Princeton, NJ \hfill {\it Expected:} 2018\\
Ph.D., Politics\\
On leave, Sept. 2015 - Feb. 2017\\

\href{https://www.princeton.edu}{{\bf Princeton University}}, Princeton, NJ \hfill Oct. 2013\\
M.A., Politics\\
General Examinations: American Politics, Formal and Quantitative Methodology\\

\href{https://www.wustl.edu}{{\bf Washington University in St. Louis}}, St. Louis, MO  \hfill May 2010\\
B.A. \textit{magna cum laude}, Political Science

\section{Dissertation Project} {\it Essays on Political Methodology with Applications to American Electoral Politics}\\
Advisors: Kosuke Imai (Chair), David Nickerson, Nolan McCarty

\section{Working \\ Papers}
\href{http://imai.princeton.edu/research/redist.html}{A New Automated Redistricting Simulator Using Markov Chain Monte Carlo} (with Michael Higgins, Kosuke Imai, and Alexander Tarr)\\\\
\href{http://imai.princeton.edu/research/linkage.html}{Using a Probabilistic Model to Assist Merging of Large-scale Administrative Records} (with Ted Enamorado and Kosuke Imai)\\\\
...
\textsf{fastLink}: \textsf{R} Package for Fast Probabilistic Record Linkage (with Ted Enamorado and Kosuke Imai)

\section{Other \\ Writings}
\href{http://www.electionstudies.org/studypages/anes_timeseries_2016/anes_timeseries_2016voteval_userguidecodebook.pdf}{User's Guide and Codebook for the ANES 2016 Time Series Voter Validation Supplemental Data} (with Ted Enamorado and Kosuke Imai)

\section{Professional Experience}
{\bf State of Pennsylvania}, Harrisburg, PA \hfill Jan. 2018 - Feb. 2018\\
{\it Consulting Expert}
\vspace{-2mm}
\begin{itemize}
\item[-] Utilized new Markov chain Monte Carlo algorithms to assess whether proposed Pennsylvania redistricting plans were gerrymandered
\vspace{-2mm} 
...
{\bf Facebook}, Menlo Park, CA \hfill Aug. 2017 - Nov. 2017\\
{\it Research Intern}, Demography and Survey Sciences
\vspace{-2mm}
\begin{itemize}
...
\vspace{-2mm}
\item[-] Designed and implemented large-scale online experiments to benchmark new survey designs for modeling individual-level treatment effect estimates
\vspace{-2mm}
\item[-] Weighted surveys using poststratification, raking, and multilevel regression/poststratification
\end{itemize}
...
\section{Software} \href{https://github.com/kosukeimai/redist}{R package {\tt redist}: Markov chain Monte Carlo Methods 
for Redistricting Simulation.}\\
\href{https://github.com/kosukeimai/fastLink}{R package {\tt fastLink}: Fast Probabilistic Record Linkage.}\\
\href{https://randomizeauthor.shinyapps.io/shiny/}{Shiny app {\tt randomizeAuthor}: Replicable Author Randomization.}
...
Midwest Political Science Association \hfill 2015\\
Southern Political Science Association \hfill 2015\\ 
American Political Science Association \hfill 2014\\ 
Society for Political Methodology Conference \hfill 2014
...
%\section{Erd\"{o}s Number}
%4 (Fifield $\rightarrow$ Higgins $\rightarrow$ Rivest $\rightarrow$ Avis $\rightarrow$ Erd\"{o}s)
...
\begin{minipage}{.5\textwidth}
  \begin{flushleft}
Kosuke Imai\\
Department of Government\hfill{\href{imai@harvard.edu}{imai@harvard.edu}}\\
Harvard University
  \end{flushleft}
\end{minipage}
\begin{minipage}{.5\textwidth}
