...
\href{https://www.princeton.edu}{{\bf Princeton University}}, Princeton, NJ\\
Ph.D., Politics \hfill Nov. 2018
\vspace{-2mm}
\begin{itemize}
\item[] {\it Dissertation:} Empirical and Computational Methods for Electoral Politics
\vspace{-3mm}
\item[] {\it Committee:} Kosuke Imai (chair), David Nickerson, Nolan McCarty
\end{itemize}
\vspace{-2mm}
M.A., Politics \hfill Oct. 2013\\

\href{https://www.wustl.edu}{{\bf Washington University in St. Louis}}, St. Louis, MO\\
B.A. \textit{magna cum laude}, Political Science \hfill May 2010

\section{Working \\ Papers}
\href{https://imai.fas.harvard.edu/research/files/redist.pdf}{A New Automated Redistricting Simulator Using Markov Chain Monte Carlo} (with Michael Higgins, Kosuke Imai, and Alexander Tarr)\\\\
\href{https://imai.fas.harvard.edu/research/files/linkage.pdf}{Using a Probabilistic Model to Assist Merging of Large-scale Administrative Records} (with Ted Enamorado and Kosuke Imai)\\\\
...
{\bf Facebook}, Menlo Park, CA \hfill Sept. 2018 - Dec. 2018\\
{\it Contingent Worker}, Demography and Survey Sciences
\vspace{-2mm}
\begin{itemize}
...
\section{Software} \href{https://github.com/kosukeimai/redist}{\textsf{R} package \textsf{redist}: Markov chain Monte Carlo Methods 
for Redistricting Simulation.}\\
\href{https://github.com/kosukeimai/fastLink}{\textsf{R} package \textsf{fastLink}: Fast Probabilistic Record Linkage.}\\
\href{https://randomizeauthor.shinyapps.io/shiny/}{Shiny app \textsf{randomizeAuthor}: Replicable Author Randomization.}
