...
\section{Education} 
\begin{flushleft}\runsubsection{Princeton University | Princeton, NJ}\end{flushleft}
\vspace{-3mm}\descript{PhD in Politics, January 2019}
...
\descript{MA in Politics, October 2013}
\sectionsep

\runsubsection{Washington University in St. Louis | St. Louis, MO}\\
\descript{BA in Political Science, May 2010}
\sectionsep
...
\href{https://imai.fas.harvard.edu/research/linkage.html}{Using a Probabilistic Model to Assist Merging of Large-scale Administrative Records} (with Ted Enamorado and Kosuke Imai). 2018. Forthcoming, \textit{American Political Science Review}.\\\vspace{2mm}
...
\descript{| Research Intern and Contractor}
\location{Sept. 2017 - Nov. 2017; Sept. 2018 - present | Menlo Park, CA}
\begin{tightemize}
...
\location{High Performance Computing API's:} 
