...
Using a Probabilistic Model to Assist Merging of Large-scale Data Sets (with Ted Enamorado and Kosuke Imai)\\\\
...
\section{Software} R package {\tt redist}: Markov chain Monte Carlo Methods 
