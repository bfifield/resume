...
\href{http://imai.princeton.edu/research/linkage.html}{Using a Probabilistic Model to Assist Merging of Large-scale Data Sets} (with Ted Enamorado and Kosuke Imai)

\section{Works in \\ Progress}
Building Voter Contact Lists using Experimental Data
...
\vspace{-2mm} 
\item[-] Cleaned and harmonized shapefiles and electoral data gathered across multiple levels of government 
\end{itemize}
...
\vspace{-2mm}
\item[-] Weighted surveys using poststratification techniques and multilevel regression/poststratification
\end{itemize}
...
\begin{flushleft}
Kit Rodolfa\\
Director of Data Science \hfill{\href{shaycrk@gmail.com}{shaycrk@gmail.com}}\\
Hillary for America
  \end{flushleft}
\end{minipage}
